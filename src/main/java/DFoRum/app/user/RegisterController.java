...
import DFoRum.app.emailSender.EmailSender;
import DFoRum.app.utilities.AppdemoUtils;
import DFoRum.app.validators.UserRegisterValidator;
...
public class RegisterController {
	...
	public String registerAction(User user, BindingResult result, Model model, Locale locale) {
		...
		if (result.hasErrors()) {
			...
			String content = "Potwierdz rejestracje. Proszę wejść w poniższy link aby aktywować konto: " +
